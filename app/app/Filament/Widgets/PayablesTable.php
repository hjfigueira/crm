...
class PayablesTable extends BaseTableWidget
{
    protected static ?string $heading = 'Payables';
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('markAsPaid')
                    ...
                    ->form([
                        \Filament\Forms\Components\DatePicker::make('payment_date')->label('Payment Date')->default(now()),
                    ])
                    ->requiresConfirmation(),
            ])
            ->headerActions([
                Tables\Actions\ExportAction::make()->label('Export Payables'),
            ])
            ->paginated([10, 25, 50]);
    }
}
